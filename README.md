...
<p align="center">
  <a href="https://github.com/Rainchen537/DockWindowPreview/releases/tag/v1.0.4">
...
<p align="center">
  <a href="https://github.com/Rainchen537/DockWindowPreview/releases/download/v1.0.4/Y-Dock-v1.0.4.dmg">
...
| ⌥ Option+Tab 切换 | 按住 `Option` 后按 `Tab` 呼出亚克力窗口切换器，独立圆角卡片按屏幕宽度自动换行，按 `Esc` 取消。 |
...
1. 下载最新版 DMG：  
   [Y-Dock-v1.0.4.dmg](https://github.com/Rainchen537/DockWindowPreview/releases/download/v1.0.4/Y-Dock-v1.0.4.dmg)
2. 打开 DMG。
...
6. 也可以按住 `Option` 并按 `Tab` 打开窗口切换器；继续按 `Tab` 循环，松开 `Option` 后切到当前选中的窗口，按 `Esc` 可取消。
