...
<p align="center">
  <a href="https://github.com/Rainchen537/DockWindowPreview/releases/tag/v1.1.5">
...
<p align="center">
  <a href="https://github.com/Rainchen537/DockWindowPreview/releases/download/v1.1.5/Y-Dock-v1.1.5.dmg">
...
| ⌥ Option+Tab 切换 | 按住 `Option` 后按 `Tab` 呼出亚克力窗口切换器，按最近聚焦顺序排列，按 `Esc` 取消。 |
...
1. 下载最新版 DMG：  
   [Y-Dock-v1.1.5.dmg](https://github.com/Rainchen537/DockWindowPreview/releases/download/v1.1.5/Y-Dock-v1.1.5.dmg)
2. 打开 DMG。
